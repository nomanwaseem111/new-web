            ...
            <Stack direction="row"
               ...
               justifyContent="space-between"
                ...
                <Box sx={{height:'500px',width:"900px"}}>
                    <Typography variant='span' sx={{ml:"5px", height:"100px" , fontSize:"30px", fontWeight:"bold",fontFamily:"sans-serif"}}>Smart Products</Typography>
                    <Typography variant='h1' sx={{mt:"20px",mb:"20px", fontSize:"110px" ,fontWeight:"400"}}>Winter Offer <br /> 2024 Collection</Typography>
