      ...
      <Stack direction="row" width="90%" margin="auto" height="auto" mt="100px">
        <Stack width="25%" height="auto">
          ...
          <TextField
            ...
            label="Search Here..."
            variant="outlined"
            sx={{ width: "340px", mt: "20px", mx: "15px" }}
          />
          <SearchIcon
            sx={{
              width: "50px",
          ...
          />
          <Typography variant="h5" mt="50px" ml="15px">
            Categories
          </Typography>
          <Stack mt="20px">
            <Box>
          ...
          >
            <Box mb="50px">
              ...
              <Box textAlign="center">
                <Typography component="p" sx={{ fontSize: "22px", mt: "10px" }}>
                ...
                <Typography component="p" sx={{ fontSize: "22px", mt: "8px" }}>
                  €35.6
                </Typography>
              </Box>
            </Box>
