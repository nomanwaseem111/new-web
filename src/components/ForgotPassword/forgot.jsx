...
const forgot = () => {
  return (
    ...
    <Grid sx={{backgroundColor: { md: "white", xs: "white",sm:"grey" }}}>
    <Container maxWidth="xl"   sx={{display:{md:"flex",xs:"flex"},width:{md:"auto",xs:"auto"}}}>
    <Stack  display="flex" justifyContent="center" ml={{md:"400px",xs:"none"}} mt="200px" sx={{width:{md:"650px",xs:"350px"},height:{md:"370px",xs:"auto"}, padding:{md:"40px",xs:"15px"},backgroundColor:{md:"#f3f3f3",xs:"#f3f3f3"}, borderRadius:{md:"20px",xs:"10px"},paddingTop:{xs:"30px",md:"50px"}}}>
